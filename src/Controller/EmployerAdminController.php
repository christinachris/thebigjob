...
class EmployerAdminController extends AppController
{
    ...
    public function isAuthorized($user = null) {
        if( $this->Auth->user('type')=='Employer'){
            if (in_array($this->request->action, ['index', 'settings'])) {
...
//        $this->set(compact('popularArticles', 'viewsOverTime'));
     ...
     * Settings form
     *
     * @return Response|null Redirects to itself after saving.
     */
