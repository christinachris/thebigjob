...
<div class="site-section bg-light">
    <div class="container">
            ...
            <?php echo $this->Form->file('file',['class'=>'form-control']);?>
                        ...
                        <div style="margin-top: 4%">
                            ...
                            <table id="dynamic_field">
                                <tr>
                                    <td><?php echo $this->Form->control('Skills.' . '0' . '.name', ['required'=>true,'label'=>false,'placeholder' => 'Enter your skill name', 'class' => 'form-control']) ?></td>
                        ...
                        <div style="margin-top: 4%">
                            ...
                            <table id="dynamic_field2">
                                ...
                                <tr>
                                    <td><?php echo $this->Form->control('Job.' . '0' . '.title', ['required'=>true,'label'=>false,'placeholder' => 'Job Title', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Job.' . '0' . '.company', ['required'=>true,'label'=>false,'placeholder' => 'Company', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Job.' . '0' . '.desc', ['required'=>false,'label'=>false,'placeholder' => 'Description', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Job.' . '0' . '.start', ['required'=>true,'type'=>'date','label'=>false,'placeholder' => 'start Time', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Job.' . '0' . '.finish', ['required'=>false,'type'=>'date','label'=>false,'placeholder' => 'End Time', 'class' => 'form-control']) ?></td>
                        ...
                        <div style="margin-top: 4%">
                            ...
                            <table id="dynamic_field3">
                                ...
                                <tr>
                                    <td><?php echo $this->Form->control('Qua.' . '0' . '.degree_name', ['required'=>true,'label'=>false,'placeholder' => 'Degree Name', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Qua.' . '0' . '.degree_level', ['required'=>false,'label'=>false,'placeholder' => 'Degree Level', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Qua.' . '0' . '.expected_graduation_date', ['type'=>'date','required'=>true,'label'=>false,'placeholder' => 'Expected graduation date', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Qua.' . '0' . '.gpa', ['required'=>false,'label'=>false,'placeholder' => 'GPA','class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Qua.' . '0' . '.major', ['required'=>false,'label'=>false,'placeholder' => 'Major', 'class' => 'form-control']) ?></td>
                                    <td><?php echo $this->Form->control('Qua.' . '0' . '.institution', ['required'=>true,'label'=>false,'placeholder' => 'Institution', 'class' => 'form-control']) ?></td>
            ...
            <div class="bt">
                <?= $this->Form->button('Save', array('name' => 'btn1')) ?>
            </div>
