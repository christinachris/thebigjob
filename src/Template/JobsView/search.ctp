                    ...
                    <div class="job-post-item bg-white p-4 d-block d-md-flex align-items-center">
                        ...
                        <div class="mb-4 mb-md-0 mr-5">
                            ...
                            <div class="job-post-item-body d-block d-md-flex">
                                <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span>Facebook, Inc.</div>
                                <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span>New York City, USA</div>
                                <div class="mr-3"><span class="fl-bigmug-line-portfolio23"></span><?= h($job->salary) ?>/per week</span></div>
                            </div>
                        </div>
